...
namespace tutorial
{
    ...
    struct LocalizedMessage
    {
        ...
        LocalizedMessage() :
            text(""), color(tcod::ColorRGB{ 255, 255, 255 }), stack(false)
        {
        }
    ...
    public:
        ...
        // params: map of placeholder names to values, e.g., {"amount", "5"}
    ...
    private:
        ...
        // Parse a message JSON object (handles text, color, stack fields)
